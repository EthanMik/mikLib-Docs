...
![VS Code Installation](./img/vscode_install.png)
...
![Vex Robotics Extension install](./img/vex_install.png)
...
![C++ Extension](./img/cpp_install.png)
...
![Vex Robotics Extension install](./img/mikLibdownload.png)
...
![Import Template](./img/import.png)
...
![Import Template](./img/import2.png)

Navigate to the folder src then robot-config.cpp to get started!

![Import Template](./img/robot-config.png)
